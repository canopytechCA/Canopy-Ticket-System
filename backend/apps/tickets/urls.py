...
urlpatterns = [
    ...
    path("tech/tickets/<int:pk>/delete/", views.TechTicketDeleteConfirm.as_view(), name="tech_ticket_delete_confirm"),
    path("tech/tickets/<int:pk>/merge/", views.TechTicketMergeConfirm.as_view(), name="tech_ticket_merge_confirm"),
    ...
    path("tech/bulk/delete-confirm/", views.TechBulkDeleteConfirm.as_view(), name="tech_bulk_delete_confirm"),
